...
class LineConsumerTask<E> implements Runnable{
    ...
    public LineConsumerTask(BlockingQueue<E> sharedQueue, String fileName, Integer batchSize, Integer partitions, CyclicBarrier cyclicBarrier) {
        this.sharedQueue = sharedQueue;
        this.fileName = fileName + IConstants.FILE_SUFFIX;
